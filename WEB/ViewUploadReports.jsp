...
<body class="bg-black muli">
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            <div>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">View Patients Reports</h1>
                <br><br>
                <%
		...
		Iterator<String> itr = lt.iterator();
 		%>
				...
				<thead>
				<tr style="color: white;"><th>File ID</th><th>Patient ID</th><th>Download</th></tr>
				<%
				while(itr.hasNext()){
				%>
				<tr style="color: white;"><td><%=itr.next() %></td><td><%=itr.next() %></td>
				<td><a href="Download1?da=<%=itr.next()%>" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">Download</a>
				<%} %>
				</table>
				</div>
        </div>
