...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
      ...
      <!--  <a href="RelativeLogin.jsp" class="button bg-white black fw-600 no-underline mx-5">Relative</a> -->
        <a href="CloudLogin.jsp" class="button bg-white black fw-600 no-underline mx-5">Cloud</a>
       </div>
    </nav>
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            <div>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Relative Registration</h1>
                ...
                <input type="text"
                        ...
                        placeholder="Enter Relative Name" name="RelativeName"> &nbsp;&nbsp;&nbsp;
                        <br><br>
                    <input type="text"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                        placeholder="Enter Relative ID" name="RelativeID"> 
                        <br><br>
                        <input type="password"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                        placeholder="Enter Password" name="RelativePassword"> &nbsp;&nbsp;&nbsp;
                        <br><br>
                        <input type="text"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                        placeholder="Enter Relative Contact" name="RelativeMobile">
                        <br><br>
                    <input type="text"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                        placeholder="Enter Relative Country" name="RelativeCountry">&nbsp;&nbsp;&nbsp;
						<br><br>
                        <input type="text"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                        placeholder="Enter Relative City" name="RelativeCity">
						<br><br>
                        <input type="text"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                        placeholder="Enter Relative Address" name="RelativeAddress"> &nbsp;&nbsp;&nbsp;
                        <br><br>
