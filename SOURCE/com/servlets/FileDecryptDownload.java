...
public class FileDecryptDownload extends HttpServlet {
	...
	//	String sql2="SELECT status1 FROM relativerequest WHERE uploadedId='3' AND UID='ibraheem@gmail.com'";
        ...
        // If the file is not approved, send a JavaScript response
        response.setContentType("text/html");
        PrintWriter out = response.getWriter();
        out.println("<html><body>");
        out.println("<script type='text/javascript'>");
        out.println("alert('File is not Approved by Patient');");
        out.println("window.location.href='ViewPFiles.jsp';"); 
        out.println("</script>");
